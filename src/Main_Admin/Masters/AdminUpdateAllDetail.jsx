...
const AdminUpdateAllDetail = () => {
  ...
  return (
    <>
      <AdminDashboard />
      <Container className="shadow p-3 bg-body rounded" style={{ marginTop: "80px" }}>
        <h3 style={{ fontWeight: "inherit", backgroundImage: "linear-gradient(to right, #004e92, #990033)", borderRadius: "10px", color: 'whitesmoke' }}>Update Personal Data</h3>
        ...
        <h3 style={{ fontWeight: "inherit", backgroundImage: "linear-gradient(to right, #004e92, #990033)", borderRadius: "10px", color: 'whitesmoke' }}>Update Professional Data</h3>
        ...
        <h3 style={{ fontWeight: "inherit", backgroundImage: "linear-gradient(to right, #004e92, #990033)", borderRadius: "10px", color: 'whitesmoke' }}>Update Address Data</h3>
        <Form style={{ marginTop: "5%" }}>
          <Row className="mb-3">
        ...
        <h3 style={{ fontWeight: "inherit", backgroundImage: "linear-gradient(to right, #004e92, #990033)", borderRadius: "10px", color: 'whitesmoke' }}>Update Academic Data</h3>
        <b style={{ marginTop: "2%" }} >10th Details</b>
        <Form style={{ marginTop: "5%" }}>
          <Row className="mb-3">
